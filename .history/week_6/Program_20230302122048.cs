  ...
  public static class MyWeekSix
  {
    public static void Main(string[] args)
    {
      ...
      */
      ...
      // }
      // Console.WriteLine($"The class average {total / gradeCounter}");
      //  write a for loop
      // for (int i = 1; i <= 10; i++)
      // {
      //   Console.WriteLine(i);
      ...
      // for (int i = 10; i == 1; i--)
      // {
      //   Console.WriteLine($"How many times do I print{i}");
      // }
      ...
      // using a foreach loop in c# create a progrm that fuel a car for a maximum of 1000
      ...
      foreach (int i in Enumerable.Range(1, 1000))
      {
        ...
        fuel += i;
        Console.WriteLine($"Adding {i} units of fuel. Total fuel: {fuel}");
      }

      Console.WriteLine($"Final fuel level: {fuel}");
    }
  }
}
